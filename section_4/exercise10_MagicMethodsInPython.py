...
#print(some_club.name)
my_club = Club('Barcelona FC')
#print(my_club.name)
my_club.players.append('Carles Puyol')
my_club.players.append('Ronaldinho')
my_club.players.append(f"Samuel Eto'o")
